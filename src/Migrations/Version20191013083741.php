...
final class Version20191013083741 extends AbstractMigration {
    ...
    private function upSQLite() {
        ...
        $this->addSql('CREATE TABLE tag (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, article_id INTEGER DEFAULT NULL, tag VARCHAR(255) NOT NULL, created DATETIME NOT NULL)');
    ...
    private function upPostgreSQL() {
        ...
        $this->addSql('CREATE TABLE tag (id INT NOT NULL, article_id INT DEFAULT NULL, tag VARCHAR(255) NOT NULL, created TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_389B7837294869C ON tag (article_id)');
